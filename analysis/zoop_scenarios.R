...
#create met file for 5, 6, and 10C warming temp scenario
#met <- read.csv("inputs/met.csv")
#met_4C_warmer <- met |> 
#  mutate(AirTemp = AirTemp + 4)
#write.csv(met_4C_warmer,"inputs/met_plus4C.csv", row.names = F)

#"topt1","topt2","topt3","topt1_plus5","topt2_plus5","topt3_plus5","plus6C"
# "plus5C", "plus10C", "norm", "plus2C", "plus0.5C", "plus1C", "plus3C"
scenario <- "norm" 
